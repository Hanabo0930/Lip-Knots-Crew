...
if (!['business','rules','mail','login-cleanup','row-queue','row-success','creation-journey','received-staff-journey','admin-creation-audit','admin-mutation-audit','native-creation-retry'].includes(suite)) throw new Error('UNKNOWN_LOCAL_ACCEPTANCE_SUITE');
